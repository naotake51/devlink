 ...
 * @package
 */
export const projectSelectForProjectDevPointSchedule = {
  startDate: true,
} satisfies Prisma.ProjectSelect;

type ProjectPayloadForProjectDevPointSchedule = Prisma.ProjectGetPayload<{
  select: typeof projectSelectForProjectDevPointSchedule;
}>;

interface ProjectDevPointScheduleProps {
  project: ProjectPayloadForProjectDevPointSchedule;
}
...
export function ProjectDevPointSchedule({
  project,
}: ProjectDevPointScheduleProps) {
  const _today = today();
